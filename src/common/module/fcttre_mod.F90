...
!     ------------------------------------------------------------------
 ...
 &                   RTWAT_RTICE_R, RTWAT_RTICECU_R, RKOOP1, RKOOP2
  ...
  PURE ELEMENTAL FUNCTION FOEEW(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOEDE(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOEDESU(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOELH(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOELDCP(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOEALFA(PTARE)
  ...
  !        INPUT : PTARE = TEMPERATURE
  PURE ELEMENTAL FUNCTION FOEEWM(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOE_DEWM_DT(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOEDEM(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOELDCPM(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOELHM(PTARE)
  ...
  !        INPUT : PTARE = TEMPERATURE
  PURE ELEMENTAL FUNCTION FOETB(PTARE)
  ...
  !               INPUT : PTARE = TEMPERATURE
  PURE ELEMENTAL FUNCTION FOEALFCU(PTARE)
  ...
  !     Pressure of water vapour at saturation
  !        INPUT : PTARE = TEMPERATURE
  PURE ELEMENTAL FUNCTION FOEEWMCU(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOEDEMCU(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOELDCPMCU(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOELHMCU(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOEEWMO(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOEELIQ(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOELSON(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOEIES_V(PTARE)
  ...
  PURE ELEMENTAL FUNCTION FOEEWM_V(PTARE,EXP1,EXP2)
  ...
  PURE ELEMENTAL FUNCTION FOEEWMCU_V(PTARE,EXP1,EXP2)
